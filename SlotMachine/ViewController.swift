...
class ViewController: UIViewController {
    ...
    // Helper function to setup Container Views
    
    // let "k" creates the constant that cannot be changed after declaration
    
    //Set margin to 10.0 on left and right of container
    ...
    func setupContainerViews() {
        ...
        self.secondContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: firstContainer.frame.height, width: self.view.bounds.width - (kMarginForView * 2), height: self.view.bounds.height * (2 * kSixth)))
